...
#define GAIN_FACTOR 	274			//电压增益系数
#define VDDREF 			5.015		//ADC参考电压	
#define DC_ZERO	    	2.51		//直流零基准点
#define AC_ZERO 		2040		//交流零点
#define ELE_ZERO		3.0			//电流零点
#define ADC_BUFF_SIZE	60			//ADC采样点数
...
#define RELAY_DELAY		100				//200ms
#define MAX_ELE			7				//电流上限
#define LOW_POWER		75					//电压下限
#define HIGH_POWER		280					//电压上限
